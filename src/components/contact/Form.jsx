...
const Form = () => {
  ...
  // Or set them as environment variables: VITE_EMAILJS_SERVICE_ID, VITE_EMAILJS_TEMPLATE_ID, VITE_EMAILJS_PUBLIC_KEY
  const SERVICE_ID = import.meta.env.VITE_EMAILJS_SERVICE_ID || "service_6lzy5se";
  const TEMPLATE_ID = import.meta.env.VITE_EMAILJS_TEMPLATE_ID || "template_yp1ad9k";
  const PUBLIC_KEY = import.meta.env.VITE_EMAILJS_PUBLIC_KEY || "tDhV0UQv51f-WTWRl";
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      if (
        ...
        const mailtoLink = `mailto:hamdyabuelkhair@gmail.com?subject=${encodeURIComponent(
      ...
      const templateParams = {
        ...
        to_email: "hamdyabuelkhair@gmail.com",
      };
      ...
      errorMessage += "Please check the browser console for details or contact me directly at hamdyabuelkhair@gmail.com";
    ...
    <div>
      ...
      <div className="mx-2">
        <form className="flex flex-col gap-4 mt-4" onSubmit={handleSubmit}>
          ...
          >
            {isLoading ? "Sending..." : "Submit"} {telegramSVG}
          </button>
        </form>
      </div>
    </div>
